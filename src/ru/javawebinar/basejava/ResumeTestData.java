...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        resume.sections.put(SectionType.ACHIEVEMENT, new ListSection<>(achiveList));
        ...
        resume.sections.put(SectionType.QUALIFICATIONS, new ListSection<>(qualiList));
        ...
        resume.sections.put(SectionType.EXPERIENCE, new ListSection<>(workPlaces));
        ...
        resume.sections.put(SectionType.EDUCATION, new ListSection<>(eduPlaces));

        System.out.println(resume);
        System.out.println("----------------------------");
        for (ContactType type: ContactType.values()) {
            System.out.println(type.getTitle() + resume.contacts.get(type));
        }
        System.out.println("----------------------------");
